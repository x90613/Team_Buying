...
public class NotifyController {
    ...
    public ResponseEntity<String> notifyHost(@PathVariable Integer hostFormId, @RequestBody Map<String, Object> requestBody) {
        ...
        if (hostId == null) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Host not found for hostFormId: " + hostFormId);
        }
