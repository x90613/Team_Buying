...
public class ParticipantForm {
    ...
    @Column(name = "joinedAt", nullable = false, columnDefinition = "TIMESTAMP DEFAULT CURRENT_TIMESTAMP")
    ...
    public ParticipantForm(Integer hostFormId, Integer participantId, String username, Integer status, Integer paymentStatus) {
