...
public class HostForm {
    ...
    public HostForm(Integer hostId, Integer menuId, String title, String description, Integer status,
                    LocalDateTime startTime, LocalDateTime deadTime, Boolean participantInformation,
                    String link, Boolean open) {
        this.hostId = hostId;
        this.menuId = menuId;
        this.title = title;
